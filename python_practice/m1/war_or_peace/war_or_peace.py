...
all_cards = [
    card.Card('diamond', '2', 2), card.Card('diamond', '3', 3), card.Card('diamond', '4', 4),
    card.Card('diamond', '5', 5), card.Card('diamond', '6', 6), card.Card('diamond', '7', 7), 
    card.Card('diamond', '8', 8), card.Card('diamond', '9', 9), card.Card('diamond', '10', 10), 
    card.Card('diamond', 'Jack', 11), card.Card('diamond', 'Queen', 12), card.Card('diamond', 'King', 13), 
    card.Card('diamond', 'Ace', 14), card.Card('heart', '2', 2), card.Card('heart', '3', 3), 
    card.Card('heart', '4', 4), card.Card('heart', '5', 5), card.Card('heart', '6', 6), 
    card.Card('heart', '7', 7), card.Card('heart', '8', 8), card.Card('heart', '9', 9), 
    card.Card('heart', '10', 10), card.Card('heart', 'Jack', 11), card.Card('heart', 'Queen', 12), 
    card.Card('heart', 'King', 13), card.Card('heart', 'Ace', 14),  card.Card('spade', '2', 2),
    ...
    card.Card('club', '2', 2), card.Card('club', '3', 3), card.Card('club', '4', 4), 
    card.Card('club', '5', 5), card.Card('club', '6', 6), card.Card('club', '7', 7), 
    card.Card('club', '8', 8), card.Card('club', '9', 9), card.Card('club', '10', 10), 
    card.Card('club', 'Jack', 11), card.Card('club', 'Queen', 12), card.Card('club', 'King', 13), card.Card('club', 'Ace', 14)
]
