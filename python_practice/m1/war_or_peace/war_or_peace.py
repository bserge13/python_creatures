...
all_cards = [
    card.Card('diamond', '2', 2), card.Card('diamond', '3', 3),
    ...
    card.Card('diamond', 'King', 13), card.Card('diamond', 'Ace', 14), 
    ...
    card.Card('heart', 'Ace', 14),  card.Card('spade', '2', 2),
    ...
    card.Card('club', '2', 2), card.Card('club', '3', 3),
